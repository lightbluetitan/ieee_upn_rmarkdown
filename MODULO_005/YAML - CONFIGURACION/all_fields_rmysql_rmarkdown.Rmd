...
all_fields <- dbConnect(RMySQL::MySQL(),dbname='world',username='root',password='Limitless1978',host='localhost',port=3306)

knitr::opts_chunk$set(echo = TRUE,connection="all_fields")
```
...
```{sql connection=all_fields}

select Country_name,Population,GNP from country
```
